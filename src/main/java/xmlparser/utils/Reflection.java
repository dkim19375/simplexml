...
import static xmlparser.utils.Reflection.ClassType.ARRAY;
import static xmlparser.utils.Reflection.ClassType.ENUM;
import static xmlparser.utils.Reflection.ClassType.LIST;
import static xmlparser.utils.Reflection.ClassType.MAP;
import static xmlparser.utils.Reflection.ClassType.OBJECT;
import static xmlparser.utils.Reflection.ClassType.SET;
import static xmlparser.utils.Reflection.ClassType.SIMPLE;
...
public enum Reflection {
    ...
    private static String findAbstractTypeName(final XmlAbstractClass annotation, final XmlElement node) {
        if (!annotation.tag().isEmpty()) {
            ...
            if (child == null)
                throw new InvalidAnnotation(format("Missing tag %s in element %s", annotation.tag(), node.name));
